...
public class DataPickerDialog extends Dialog {
    ...
    public interface OnDataSelectedListener {
        void onDataSelected(String itemValue, int position,int position2);
        void onCancel();
    }
    ...
    public static class Builder {
        ...
        public DataPickerDialog create() {
            ...
            final LoopView loopData2 = (LoopView) view.findViewById(R.id.loop_min);
            loopData.setArrayList(params.dataList);
            loopData.setNotLoop();
            loopData2.setArrayList(params.dataList2);
            loopData2.setNotLoop();
            if (params.dataList.size() > 0&&params.dataList2.size() > 0) {
            ...
            view.findViewById(R.id.tx_finish).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    params.callback.onDataSelected(getCurrDateValue(),loopData.getCurrentItem(), loopData2.getCurrentItem());
                }
            });
