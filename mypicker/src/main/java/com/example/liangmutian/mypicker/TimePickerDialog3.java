...
public class TimePickerDialog3 extends Dialog {
    ...
    public TimePickerDialog3(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public TimePickerDialog3 create() {
            final TimePickerDialog3 dialog = new TimePickerDialog3(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
            View view = LayoutInflater.from(context).inflate(R.layout.layout_picker_time3, null);
