...
public class DatePickerDialog extends Dialog {
    ...
    public static class Builder {
        ...
        private LoopView loopYear,loopDay,loopMonth;

        public void setDate(int year,int mon,int day){
            loopYear.setCurrentItem(year-2000);
            loopMonth.setCurrentItem(mon-1);
        ...
        public DatePickerDialog create() {
            ...
            loopDay = (LoopView) view.findViewById(R.id.loop_day);
            ...
            loopYear = (LoopView) view.findViewById(R.id.loop_year);
...
//            }
            ...
            loopMonth = (LoopView) view.findViewById(R.id.loop_month);
