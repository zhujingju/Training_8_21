...
public class VerifyPhoneActivity extends BaseMqttActivity {
    @BindView(R.id.cp_fh)
    ImageView cpFh;
    ...
    public int setLayoutId() {
        return R.layout.verify_phone_activity;
    }
...
//                }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    switch (cmd) {
                        case "changephoneconfirmoldphone_ok":

                            handler.sendEmptyMessageDelayed(1000, 500);

                            break;
                        case "changephoneconfirmoldphone_failed":
                            ...
                            break;
                        case "codechangephoneconfirmoldphone_ok":
                            handler.sendEmptyMessage(2000);
                            break;
                        case "codechangephoneconfirmoldphone_failed":
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1000:
                    ...
                    finish();
                    startActivity(new Intent(VerifyPhoneActivity.this,SetPhoneActivity.class));
                    break;
                case 1001:
                    if (dialog != null) {
                        dialog.dismiss();
                    }
                    Toast.makeText(context, "验证失败！" + msg.obj.toString(), Toast.LENGTH_LONG).show();
                    break;
    ...
    public void push_yzm(String phone) {
        ...
        try {
            ...
            //发送请求所有数据消息
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("cmd", "codechangephoneconfirmoldphone");
            jsonObject.put("oldphone", phone);
            jsonObject.put("clientid", Tool.getIMEI(getContext()));
            jsonObject.put("uname", MainActivity.NameUser);
            String js = jsonObject.toString();
