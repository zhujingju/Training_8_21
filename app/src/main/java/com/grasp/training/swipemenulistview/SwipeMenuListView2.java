package com.grasp.training.swipemenulistview;
 ...
 * 
 */
public class SwipeMenuListView2 extends SwipeMenuListView implements OnScrollListener {
	...
	Handler ha=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what){
				case 1000:
					if(SwipeMenuListView2.this!=null){
						onRefreshComplete();
					}
					break;
			}
	...
	private void onRefresh() {
		if (refreshListener != null) {
			...
			ha.sendEmptyMessageDelayed(1000,5000);
		}
	}
